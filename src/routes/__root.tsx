  ...
  head: () => ({
    meta: [
      ...
      { title: "Aurelle | Solid 18ct Gold Fine Jewellery, Made in Melbourne" },
      {
        name: "description",
        content:
          "Australian fine jewellery cast in solid recycled 18ct gold and hand-finished in Fitzroy, Melbourne.",
      },
      { name: "author", content: "Aurelle Fine Jewellery" },
      { property: "og:title", content: "Aurelle | Solid 18ct Gold Fine Jewellery" },
      {
        property: "og:description",
        content: "Hand-finished Australian fine jewellery in solid recycled 18ct gold.",
      },
